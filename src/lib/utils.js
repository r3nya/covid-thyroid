...
export const NO_NEEDS =
	"Показаний к дополнительному тиреоидологическому обследованию не имеется";
...
export function getResult(answers) {
	...
	const allNoAnswers = answers.every(
		(answer) => answer === "no" || answer === "skip",
	);
